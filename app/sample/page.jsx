      ...
      <div className={styles.container}>
        ...
        <section>
          ...
          <div className={styles.link}>
            ...
            <a href="https://nextjs.org/docs/pages/api-reference/components/link">Link Document</a>
          </div>
        </section>
        ...
        <section>
          ...
          <Image
            ...
            <div className={styles.link}>
            <a href="https://nextjs.org/docs/pages/api-reference/components/image">Image Document</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className={styles.link}>
            <a href="https://legacy.reactjs.org/docs/hooks-state.html">useState Document</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className={styles.link}>
            <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API">Fetch API Document</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className={styles.link}>
            <a href="https://react.dev/learn/rendering-lists">Data Mapping Document</a>
          </div>
        </section>
        ...
        <section>
          ...
          <div className={styles.link}>
            <a href="https://react.dev/learn/passing-props-to-a-component">Child Component and Props Document</a>
          </div>
        </section>
      </div>
    </div>
