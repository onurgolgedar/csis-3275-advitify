      ...
      <section id="hero" className="bg-body-tertiary">
        <div className="container bg-body-tertiary">
          <div className="row">
                  ...
                  <div className="container">
                    <div className="row justify-content-md-center">
                      ...
                      <div className="col-sm col-md-auto">
                        <img
                          width={120}
                          src="/_next/static/media/main_image2.43ec8873.png"
                          className="img-fluid"
                          alt=""
                        />
                      </div>
            ...
            >
              <img
                src="/_next/static/media/main_image1.46df7911.png"
                className="img-fluid"
                alt=""
              />
            </div>
              ...
              >
                <li className="nav-item">
                  <a href="#" className="nav-link align-middle px-0">
                    ...
                    <span className="ms-1 d-none d-sm-inline">Software</span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                    <i className="fs-4 bi-people"></i>{" "}
                    <span className="ms-1 d-none d-sm-inline">Database</span>{" "}
                  </a>
                </li>
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                ...
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                    <i className="fs-4 bi-people"></i>{" "}
                    <span className="ms-1 d-none d-sm-inline">Automation</span>{" "}
                  </a>
                </li>
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                ...
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
                    <i className="fs-4 bi-people"></i>{" "}
                    <span className="ms-1 d-none d-sm-inline">Computing</span>{" "}
                  </a>
                </li>
                <li>
                  <a href="#" className="nav-link px-0 align-middle">
            ...
            <div className="row row-cols-1 row-cols-md-3 text-center">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Expertise Area</small>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col">
                <div className="card">
                  <img
                    className="card-img-top embed-responsive-item"
                    src="https://images.unsplash.com/photo-1544723795-3fb6469f5b39?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=389&q=80"
                    style={{
                      width: "100%",
                      height: "40vh",
                      objectFit: "cover",
            ...
            <div className="row row-cols-1 row-cols-md-3 text-center">
              <div className="col">
                <div className="card">
                  <img
                    className="card-img-top"
                    src="https://images.unsplash.com/photo-1604403428907-673e7f4cd341?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80"
                    style={{
                      width: "100%",
                      height: "40vh",
                      objectFit: "cover",
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Short Description</p>
                    <p className="card-text">
                      <small className="text-muted"># of consultants</small>
                    </p>
                  </div>
                </div>
              </div>
              <div className="col">
                <div className="card">
                  <img
                    className="card-img-top embed-responsive-item"
                    src="https://images.unsplash.com/photo-1562408590-e32931084e23?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80"
                    style={{
                      width: "100%",
                      height: "40vh",
                      objectFit: "cover",
