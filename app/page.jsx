                    ...
                    <div className="row justify-content-md-center">
                      <div className="col-sm">
                        ...
                        {user ? (
                          ...
                          <Link href="/signIn" className="btn-get-started">
                            Get Started
                          </Link>
                        )}
                      </div>
              ...
              {consultants?.map((consultant, index) => {
                return (
                  <div key={index} className="col">
                    <Link
                      href={`/consultant_profile/${consultant.id}`}
                    ...
                    >
                      <div className="card mb-4">
                        ...
                        <div className="card-body">
                          ...
                          <p className="card-text">
                            <small className="text-muted">
                              {category.numberOfConsultants} of consultants
                            </small>
                          </p>
                        </div>
                      </div>
...
const categories = [
  {
    name: "Software",
    description:
      "Design and maintenance of computer programs for specific tasks.",
    numberOfConsultants: 76,
    imgUrl:
      "https://images.unsplash.com/photo-1604403428907-673e7f4cd341?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80",
  },
  {
    name: "Cybersecurity",
    description:
      "Protection of internet-connected systems from digital threats.",
    numberOfConsultants: 33,
    imgUrl:
      "https://images.unsplash.com/photo-1562408590-e32931084e23?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80",
  },
  {
    name: "Cloud computing",
    description:
      "Delivery of internet-based services like storage, databases, and software.",
    numberOfConsultants: 129,
    imgUrl:
      "https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80",
  },
  {
    name: "Database",
    description: "Management and organization of structured sets of data.",
    numberOfConsultants: 143,
    imgUrl:
      "https://images.unsplash.com/photo-1633412802994-5c058f151b66?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80",
  },
  {
    name: "Customers",
    description:
      "Understanding and satisfying the needs of product or service users.",
    numberOfConsultants: 97,
    imgUrl:
      "https://images.unsplash.com/photo-1581093805071-a04e696db334?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
  },
  {
    name: "Automation",
    description:
      "Use of systems to control industrial processes, reducing human intervention.",
    numberOfConsultants: 45,
    imgUrl:
      "https://images.unsplash.com/photo-1567789884554-0b844b597180?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
  },
  {
    name: "Artificial intelligence",
    description: "Creation of machines that mimic human intelligence.",
    numberOfConsultants: 122,
    imgUrl:
      "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=930&q=80",
  },
  {
    name: "Computing",
    description:
      "Study and application of algorithms, hardware, software, and networks.",
    numberOfConsultants: 98,
    imgUrl:
      "https://images.unsplash.com/photo-1617839625591-e5a789593135?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2680&q=80",
  },
  {
    name: "Data visualization",
    description:
      "Graphical representation of data to make it easily understandable.",
    numberOfConsultants: 7,
    imgUrl:
      "https://images.unsplash.com/photo-1584291527935-456e8e2dd734?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1450&q=80",
  },
  {
    name: "Embedded systems",
    description: "Design of dedicated computer systems for specific function",
    numberOfConsultants: 149,
    imgUrl:
      "https://images.unsplash.com/photo-1689535090070-647b1b194631?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
  },
];
