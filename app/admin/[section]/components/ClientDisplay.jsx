            ...
            return (
              <tr key={index}>
                ...
                <td className={styles.tableCell}>
                  {
                    searchParams.action === undefined || searchParams.action === "add"
                    ?
                    <Link className={styles.detail} href="#">Detail</Link>
                    :
                    searchParams.action === "edit"
                    ?
                    <Link
                      className={styles.btn}
                      href={`/admin/client?action=edit&fName=${client.fName}&lName=${client.lName}&email=${client.email}&phone=${client.phone}`}>EDIT
                    </Link>
                    :
                    <Link className={styles.btn} href="#">DELETE</Link>
                  }
                </td>
              </tr>
            )
